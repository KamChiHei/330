...
"\n"
""));
        dateEdit_date->setDateTime(QDateTime(QDate(2023, 12, 30), QTime(16, 0, 0)));
...
""));
        ...
        pushButton_clear->setGeometry(QRect(700, 30, 160, 40));
...
"}"));
        ...
        prevButton->setGeometry(QRect(680, 150, 91, 21));
...
"}"));
        ...
        nextButton->setGeometry(QRect(800, 150, 81, 21));
...
"}"));
        ...
        label_status->setGeometry(QRect(120, 70, 201, 31));
        ...
        pushButton_searchall->setGeometry(QRect(700, 80, 151, 41));
...
""));
        ...
        tableWidget_2->setGeometry(QRect(170, 240, 671, 301));
        stackedWidget->addWidget(page_4);
        page_5 = new QWidget();
        page_5->setObjectName("page_5");
        tableWidget_3 = new QTableWidget(page_5);
        tableWidget_3->setObjectName("tableWidget_3");
        tableWidget_3->setGeometry(QRect(240, 280, 571, 391));
